...
export const Navbar = () => {
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <Link href="#experiencia" className="text-sm font-medium hover:text-primary transition-colors">
            Experiencia
          </Link>
  ...
  <Link href="#sobre-mi" onClick={() => setOpenMenu(false)}>Sobre mí</Link>
  <Link href="#proyectos" onClick={() => setOpenMenu(false)}>Proyectos</Link>
  <Link href="#habilidades" onClick={() => setOpenMenu(false)}>Habilidades</Link>
  <Link href="#experiencia" onClick={() => setOpenMenu(false)}>Experiencia</Link>
  <Link href="#contacto" onClick={() => setOpenMenu(false)}>Contacto</Link>
